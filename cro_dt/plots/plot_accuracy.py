...
if __name__ == "__main__":
    ...
    if mode == "training":
        ...
        data_GOSDT = np.array([[0.967, 0.70, 0.928, 0.739, 0.932, 1.00, 0.776, 0.915, 0.773, 0.362, 0.623, 0.508, 0.523, 0.471],
        ...
        data_CRODT = np.array([[0.954, 0.779, 0.902, 0.739, 1.0, 1.0, 0.774, 0.943, 0.842, 0.351, 0.573, 0.538, 0.540, 0.495],
            [0.963, 0.817, 0.939, 0.786, 1.0, 1.0, 0.779, 0.962, 0.900, 0.506, 0.658, 0.572, 0.564, 0.510],
            [0.966, 0.861, 0.970, 0.824, 1.0, 1.0, 0.781, 0.975, 0.933, 0.611, 0.723, 0.601, 0.586, 0.523]])			
        data_CRODT_CS = np.array([[0.969, 0.779, 0.925, 0.739, 1.0, 1.0, 0.782, 0.944, 0.857, 0.382, 0.646, 0.538, 0.581, 0.523],
            ...
            [0.980, 0.867, 0.974, 0.839, 1.0, 1.0, 0.797, 0.977, 0.938, 0.667, 0.785, 0.601, 0.603, 0.531]])
    elif mode == "test":
        ...
        data_CRODT = np.array([[0.939, 0.776, 0.885, 0.692, 1.0, 1.0, 0.759, 0.915, 0.728, 0.347, 0.569, 0.536, 0.510, 0.483],
        ...
        data_CRODT_CS = np.array([[0.955, 0.775, 0.904, 0.692, 1.0, 0.996, 0.757, 0.913, 0.704, 0.380, 0.644, 0.536, 0.558, 0.514],
            ...
            [0.952, 0.861, 0.952, 0.778, 1.0, 0.998, 0.761, 0.907, 0.717, 0.652, 0.779, 0.596, 0.548, 0.507]])
